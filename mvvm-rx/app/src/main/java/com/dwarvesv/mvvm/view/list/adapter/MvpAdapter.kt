...
class MvpAdapter :
        ListAdapter<{{packageName}}.data.model.User, MvpViewHolder>(DataDiffCallback()) {

    private val clickSubject = PublishSubject.create<{{packageName}}.data.model.User>()
    val clickEvent: Observable<{{packageName}}.data.model.User> = clickSubject
